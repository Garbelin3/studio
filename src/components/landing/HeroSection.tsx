        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <AnimateOnScroll delay={200}>
            <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Este material exclusivo reúne 365 mensagens bíblicas para guiar seu coração todos os dias do ano. Experimente o poder da Palavra aplicada à sua rotina.
            </p>
          </AnimateOnScroll>
          <AnimateOnScroll delay={400} className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
            <a href="#oferta">
              <Button size="lg" className="w-full sm:w-auto font-bold text-lg px-10 py-7 btn-primary shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 transform hover:-translate-y-1 transition-all duration-300">
                Quero Começar Hoje
              </Button>
            </a>
            <Button variant="ghost" size="lg" className="text-muted-foreground hover:text-primary" onClick={() => setIsModalOpen(true)}>
